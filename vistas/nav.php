...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse" id="collapseDashboards" data-parent="#accordionSidenav" style="">
            ...
            <div class="collapse" id="collapseComponents" data-parent="#accordionSidenav" style="">
                <nav class="sidenav-menu-nested nav">
